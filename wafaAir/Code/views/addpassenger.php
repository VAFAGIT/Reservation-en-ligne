                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" hidden name="id_flight" class="form-control form-control-lg idFlight" value=""/>
                                    </div>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button type="submit" name="addpass" class="btn btn-dark btn-lg btn-block button">Add Passenger to Flight</button>
                                    </div>
                                </form>
...
<script> 
  ...
  let id=document.querySelector('.idFlight');
  let button=document.querySelector('.button');

  button.addEventListener("click", function() {
    
    id.value=localStorage.getItem('id_flight');
    // alert(id.value);
